...
#define OMAP4430_VDD_MPU_OPP25_UV		850000 //  200 Mhz
#define OMAP4430_VDD_MPU_OPP50_UV		920000 //  300 Mhz
#define OMAP4430_VDD_MPU_OPP100_UV              975000 //  600 Mhz
#define OMAP4430_VDD_MPU_OPPTURBO_UV            1050000 //  800 Mhz
#define OMAP4430_VDD_MPU_OPPNITRO_UV            1150000 // 1008 Mhz
#define OMAP4430_VDD_MPU_OPPNITROSB_UV          1275000 // 1200 Mhz
#define OMAP4430_VDD_MPU_OPPNITROSB2_UV         1370000 // 1350 Mhz
#define OMAP4430_VDD_MPU_OPPNITROSB4_UV         1398000 // 1400 Mhz (Extra)
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB4_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB2, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
#define OMAP4430_VDD_CORE_OPP100B_UV      	1252000
...
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100B_UV, 0, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xfa, 0x23, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	/* MPU OPP7 - OPP-NT */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1398000000, OMAP4430_VDD_MPU_OPPNITROSB4_UV),
	/* L3 OPP1 - OPP50 */
...
static struct omap_opp_def __initdata omap447x_opp_low_def_list[] = {
	...
	/* MPU OPP4 - OPP-Nitro SpeedBin */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1400000000, OMAP4470_VDD_MPU_OPPNITROSB_UV),
	/* L3 OPP1 - OPP50 */
...
omap4_opp_enable("mpu", 1450800000);
...
//#else
	...
	if (omap4_has_mpu_1_2ghz())
		omap4_opp_enable("mpu", 1200000000);
		omap4_opp_enable("mpu", 1398000000);
#endif
	if (!trimmed)
